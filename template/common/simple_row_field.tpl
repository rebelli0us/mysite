<div class="form-group <?php if ($required) { ?>required<?php } ?> row-<?php echo $id ?>">
    <label class="control-label <?php echo $page == 'checkout' ? 'col-sm-4' : 'col-sm-4' ?>" for="<?php echo $id ?>"><?php echo $label ?></label>
    <div class="<?php echo $page == 'checkout' ? 'col-sm-8' : 'col-sm-4' ?>">
